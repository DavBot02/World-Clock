...
class LocationData {
  ...
  Future<bool> fetchData() async {
    ...
    Response currentWeatherResponse = await get(Uri.parse(
    ...
    Response futureWeatherResponse = await get(Uri.parse(
    ...
    Response timeResponse = await get(Uri.parse(
    ...
    Response airQualityResponse = await get(Uri.parse(
